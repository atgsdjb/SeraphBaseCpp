/*******************************************************************************
 output_mov.h - A library for writing MPEG4.
...
#ifndef OUTPUT_MOV_H_AKW
#define OUTPUT_MOV_H_AKW
...
int output_mov(struct mp4_context_t* mp4_context,
