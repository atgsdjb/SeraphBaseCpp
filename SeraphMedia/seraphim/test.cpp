...
static void* encodeTask(void* _param){
	...
	SSyncBuffer* syncBuff = handler->getBuffer(0);
	int iResult = 0;
	int iNal;
...
void* aacEncodeThread(void* param){
	SSyncBuffer *aacBuffer=NULL;
	SMp4Creater *creater = (SMp4Creater*)param;
	aacBuffer = creater->getBuffer(1);
...
int main(int argc,char* argv){
	...
	SMp4Creater creater(name,40,param,buf);
