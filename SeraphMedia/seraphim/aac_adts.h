...
public:
	AdtsHelp(AACProfile _profile=Main,AACSampleFrequencies _sampleRate=HZ44100);//:profile(_profile),sampleRate(_sampleRate),t_byte(0),indexBit(0){adts = new uint8_t[7];};
